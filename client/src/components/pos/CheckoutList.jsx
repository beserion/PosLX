...
import { Minus, Plus, Trash2, CreditCard, Banknote, ShoppingBag, CheckCircle2 } from 'lucide-react';
                        ...
                        {cart.map((item) => (
                            ...
                            >
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-xs text-text-muted">₺{item.SalePrice} each</p>
                                </div>
                                ...
                                <span className="text-sm font-bold text-cyan-accent w-16 text-right">₺{(item.SalePrice * item.qty).toFixed(0)}</span>
